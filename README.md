...
3. **Dataset Visualization** - [View Notebook](notebooks/explore_data.ipynb), [Python](python_examples/explore_data.py)
   ...
   Visualizing your dataset allows you to Identify and remove _Outliers_ from specific clusters or whole clusters altogether.

   It is also the basis for _Balancing_ your dataset.
